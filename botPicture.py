...
# 🌟 PORT สำหรับ Render Web Service (คงไว้เพื่อความยืดหยุ่น)
...
async def on_ready():
    ...
    try:
        # 📌 บรรทัดนี้จะลงทะเบียนคำสั่ง /generate ใหม่
